...
![REST API](https://img.shields.io/badge/REST%20API-Implementation-007ACC?style=flat&logo=fastapi&logoColor=white)
![LLM Integration](https://img.shields.io/badge/LLM-Integration-blue?style=flat&logo=openai&logoColor=white&labelColor=6c757d)
...
![Machine Learning](https://img.shields.io/badge/Machine%20Learning-Basics-8A2BE2?style=flat&logo=scikitlearn&logoColor=white)



### Talking about Personal Stuffs:

- 🛠 &nbsp; Currently working on **DevOps projects** involving AWS, Kubernetes, Docker, CI/CD, and FastAPI-based backend services.
- 🚀 &nbsp; Learning **Terraform best practices**, EKS internals, production reliability concepts practical LLM integration for DevOps workflows.
- 🤝 &nbsp; Open to collaborating on **DevOps, cloud infrastructure, automation, and open-source** projects.
- 💬 &nbsp; Ask me about Docker, Kubernetes, AWS, CI/CD pipelines, FastAPI, or C++.
- ☕ &nbsp; Fun fact: Most of my debugging happens late at night, powered by music🎧 and caffeine☕.
...
- ⚙️ Automation, CI/CD, and DevOps tooling  
- 🧠 Applying LLMs to observability, incident analysis, and DevOps automation  
- 🧑‍💻 Learning how production systems actually fail (and how to fix them)
...
<br/>
![](https://nirzak-streak-stats.vercel.app/?user=dyalsingh&theme=dark&hide_border=false)
<br/>
